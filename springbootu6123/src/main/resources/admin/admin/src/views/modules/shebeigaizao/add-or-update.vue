    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="改造原因" prop="gaizaoyuanyin">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="改造原因"
                  v-model="ruleForm.gaizaoyuanyin" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.gaizaoyuanyin" label="改造原因" prop="gaizaoyuanyin">
                    <span>{{ruleForm.gaizaoyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="改造内容" prop="gaizaoneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.gaizaoneirong" label="改造内容" prop="gaizaoneirong">
                    <span>{{ruleForm.gaizaoneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="验收情况" prop="yanshouqingkuang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="验收情况"
                  v-model="ruleForm.yanshouqingkuang" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yanshouqingkuang" label="验收情况" prop="yanshouqingkuang">
                    <span>{{ruleForm.yanshouqingkuang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shebeileixing = true;
          ...
          if(o=='gaizaoyuanyin'){
            this.ruleForm.gaizaoyuanyin = obj[o];
	    this.ro.gaizaoyuanyin = true;
            continue;
          }
          if(o=='gaizaoneirong'){
	    ...
	    this.ro.gaizaoneirong = true;
          ...
          if(o=='yanshouqingkuang'){
            this.ruleForm.yanshouqingkuang = obj[o];
	    this.ro.yanshouqingkuang = true;
            continue;
          }
          if(o=='riqi'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shebeigaizao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shebeigaizaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
