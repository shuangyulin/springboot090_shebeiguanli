<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="配件类型" prop="peijianleixing">
          <el-input v-model="ruleForm.peijianleixing" 
              placeholder="配件类型" clearable  :readonly="ro.peijianleixing"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="作用描述" prop="zuoyongmiaoshu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="作用描述"
                  v-model="ruleForm.zuoyongmiaoshu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zuoyongmiaoshu" label="作用描述" prop="zuoyongmiaoshu">
                    <span>{{ruleForm.zuoyongmiaoshu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.guige = true;
          ...
          if(o=='zuoyongmiaoshu'){
            this.ruleForm.zuoyongmiaoshu = obj[o];
	    this.ro.zuoyongmiaoshu = true;
            continue;
          }
          if(o=='jiage'){
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../springbootu6123/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
