<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="点检项目" prop="dianjianxiangmu">
          <el-input v-model="ruleForm.dianjianxiangmu" 
              placeholder="点检项目" clearable  :readonly="ro.dianjianxiangmu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="点检项目" prop="dianjianxiangmu">
              <el-input v-model="ruleForm.dianjianxiangmu" 
                placeholder="点检项目" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="点检日期" prop="dianjianriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.dianjianriqi" 
                type="date"
                placeholder="点检日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.dianjianriqi" label="点检日期" prop="dianjianriqi">
              <el-input v-model="ruleForm.dianjianriqi" 
                placeholder="点检日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="点检内容" prop="dianjianneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="点检内容"
                  v-model="ruleForm.dianjianneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.dianjianneirong" label="点检内容" prop="dianjianneirong">
                    <span>{{ruleForm.dianjianneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	shebeileixing : false,
	dianjianxiangmu : false,
	dianjianneirong : false,
	dianjianriqi : false,
	gonghao : false,
  ...
  created() {
	this.ruleForm.dianjianriqi = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shebeileixing = true;
          ...
          if(o=='dianjianxiangmu'){
            this.ruleForm.dianjianxiangmu = obj[o];
	    this.ro.dianjianxiangmu = true;
            continue;
          }
          if(o=='dianjianneirong'){
            this.ruleForm.dianjianneirong = obj[o];
	    this.ro.dianjianneirong = true;
            continue;
          }
          if(o=='dianjianriqi'){
            this.ruleForm.dianjianriqi = obj[o];
	    this.ro.dianjianriqi = true;
            continue;
          }
          if(o=='gonghao'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shebeidianjian/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shebeidianjianCrossAddOrUpdateFlag = false;
                  this.parent.search();
