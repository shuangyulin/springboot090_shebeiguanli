<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="报警项目" prop="baojingxiangmu">
          <el-input v-model="ruleForm.baojingxiangmu" 
              placeholder="报警项目" clearable  :readonly="ro.baojingxiangmu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="报警项目" prop="baojingxiangmu">
              <el-input v-model="ruleForm.baojingxiangmu" 
                placeholder="报警项目" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.baojingshijian" label="报警时间" prop="baojingshijian">
              <el-input v-model="ruleForm.baojingshijian" 
                placeholder="报警时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="报警原因" prop="baojingyuanyin">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="报警原因"
                  v-model="ruleForm.baojingyuanyin" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.baojingyuanyin" label="报警原因" prop="baojingyuanyin">
                    <span>{{ruleForm.baojingyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="处理情况" prop="chuliqingkuang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="处理情况"
                  v-model="ruleForm.chuliqingkuang" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.chuliqingkuang" label="处理情况" prop="chuliqingkuang">
                    <span>{{ruleForm.chuliqingkuang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	baojingxiangmu : false,
	baojingshijian : false,
	baojingyuanyin : false,
  ...
  created() {
	this.ruleForm.baojingshijian = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='baojingxiangmu'){
            this.ruleForm.baojingxiangmu = obj[o];
	    this.ro.baojingxiangmu = true;
            continue;
          }
          if(o=='baojingshijian'){
	    ...
	    this.ro.baojingshijian = true;
          ...
          if(o=='baojingyuanyin'){
            this.ruleForm.baojingyuanyin = obj[o];
	    this.ro.baojingyuanyin = true;
            continue;
          }
          if(o=='chuliqingkuang'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shiwubaojing/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shiwubaojingCrossAddOrUpdateFlag = false;
                  this.parent.search();
