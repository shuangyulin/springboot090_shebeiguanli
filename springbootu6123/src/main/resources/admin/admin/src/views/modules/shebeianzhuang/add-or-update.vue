    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="安装内容" prop="anzhuangneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="安装内容"
                  v-model="ruleForm.anzhuangneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.anzhuangneirong" label="安装内容" prop="anzhuangneirong">
                    <span>{{ruleForm.anzhuangneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="调试结果" prop="diaoshijieguo">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="调试结果"
                  v-model="ruleForm.diaoshijieguo" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.diaoshijieguo" label="调试结果" prop="diaoshijieguo">
                    <span>{{ruleForm.diaoshijieguo}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.anzhuangshijian = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shebeileixing = true;
          ...
          if(o=='anzhuangneirong'){
            this.ruleForm.anzhuangneirong = obj[o];
	    this.ro.anzhuangneirong = true;
            continue;
          }
          if(o=='diaoshijieguo'){
            this.ruleForm.diaoshijieguo = obj[o];
	    this.ro.diaoshijieguo = true;
            continue;
          }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shebeianzhuang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shebeianzhuangCrossAddOrUpdateFlag = false;
                  this.parent.search();
