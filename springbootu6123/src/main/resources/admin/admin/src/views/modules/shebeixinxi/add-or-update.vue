    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="设备简介" prop="shebeijianjie">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shebeijianjie" label="设备简介" prop="shebeijianjie">
                    <span>{{ruleForm.shebeijianjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
